...
public class HomeActivity extends AppCompatActivity {
    ...
    // Reusable redirect function for either logout or delete
    public void redirect(){
        Intent backToLogin = new Intent(HomeActivity.this,WelcomeActivity.class);
        startActivity(backToLogin);
        finish();
    }

    // Attempts the logout procedure
        ...
        if(user!= null){
            user.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    Toast.makeText(getApplicationContext(), "Current user has been deleted", Toast.LENGTH_SHORT).show();
                    redirect();
                }
            });
        }
